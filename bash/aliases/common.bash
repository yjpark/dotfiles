...
alias set-proxy-on='export https_proxy=127.0.0.1:1102; export http_proxy=127.0.0.1:1102; export ALL_PROXY=http://127.0.0.1:1102'
alias set-proxy-off='unset https_proxy; unset http_proxy; unset ALL_PROXY'
