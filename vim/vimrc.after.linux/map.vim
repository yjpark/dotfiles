...
vmap <C-X> x<ESC>:new<CR>pggvG$:%w !xclip -selection clipboard -i<CR><ESC>:bdelete!<CR>
map <C-X> ggvG$x:new<CR>pggvG$:%w !xclip -selection clipboard -i<CR><ESC>:bdelete!<CR>
vmap <C-C> y<ESC>:new<CR>pggvG$:%w !xclip -selection clipboard -i<CR><ESC>:bdelete!<CR>
